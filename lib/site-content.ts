...
export const insights = [
  { slug: 'growth-exposes-gaps', category: 'Growth & strategy', title: 'Growth does not create every problem. It reveals the ones already there.', excerpt: 'Why disconnected marketing, sales and technology become harder to ignore as a B2B business scales.', date: '12 August 2026', isoDate: '2026-08-12', read: '5 min read', author: { name: 'Ed Booth', role: 'Founder, Prospertia' }, coverImage: '/insights/growth-exposes-gaps.png', coverAlt: 'Abstract concentric rings on a dark purple-to-teal gradient, representing joined-up commercial systems', seoTitle: 'Why Growth Exposes Gaps in B2B Marketing, Sales and Technology', seoDescription: 'Why disconnected marketing, sales and technology become harder to ignore as a B2B business scales — and where to look first.' },
  { slug: 'getting-more-from-hubspot', category: 'Sales & HubSpot', title: 'Getting more from HubSpot starts before another workflow is built', excerpt: 'The practical questions leadership teams should answer before investing in more CRM complexity.', date: '4 August 2026', isoDate: '2026-08-04', read: '5 min read', author: { name: 'Ed Booth', role: 'Founder, Prospertia' }, coverImage: '/insights/getting-more-from-hubspot.png', coverAlt: 'Abstract lines converging into a single point on a dark teal-to-purple gradient, representing a HubSpot pipeline brought into focus', seoTitle: 'Getting More From HubSpot: Questions to Ask Before You Build', seoDescription: 'The practical questions B2B leadership teams should answer before investing in more HubSpot workflows and CRM complexity.' },
  { slug: 'practical-ai-plan', category: 'AI & transformation', title: 'A practical AI plan begins with work, not tools', excerpt: 'Find the repetitive, slow and inconsistent work first. Then decide where AI genuinely helps.', date: '24 July 2026', isoDate: '2026-07-24', read: '6 min read', author: { name: 'Ed Booth', role: 'Founder, Prospertia' }, coverImage: '/insights/practical-ai-plan.png', coverAlt: 'Abstract node network on a dark purple-to-teal gradient, representing connected AI-enabled workflows', seoTitle: 'A Practical AI Plan for B2B Teams Starts With Work, Not Tools', seoDescription: 'How to build a practical AI adoption plan for a B2B business: find the repetitive work first, then decide where AI genuinely helps.' },
]
